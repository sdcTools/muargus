...
public class CMuArgCtrl {
  ...
  public boolean CombineToSafeFile(String FileName, int[] nSupps, boolean WithPrior, boolean WithEntropy, int HHIdentOption, boolean RandomizeOutput, boolean PrintBHR) {
    return MuArgusCtrlJNI.CMuArgCtrl_CombineToSafeFile(swigCPtr, this, FileName, nSupps, WithPrior, WithEntropy, HHIdentOption, RandomizeOutput, PrintBHR);
  }
