...
public class Generate extends javax.swing.JDialog {
     ...
     */
    public Generate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Use identification level");

        jRadioButton2.setText("Make all tables up to dimension");
