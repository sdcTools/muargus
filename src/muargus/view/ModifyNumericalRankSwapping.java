 ...
 * @author ambargus
 */
public class ModifyNumericalRankSwapping extends javax.swing.JDialog {

    /**
     * Creates new form ModifyNumericalRankSwapping
     */
    public ModifyNumericalRankSwapping(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyNumericalRankSwapping.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModifyNumericalRankSwapping dialog = new ModifyNumericalRankSwapping(new javax.swing.JFrame(), true);
